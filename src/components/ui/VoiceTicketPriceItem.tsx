...
export default function VoiceTicketPriceItem(props: SubscriptionPriceItemProps) {
    ...
    if (displayValue === 'small') {
        ...
        return (
            <Box h={100} w="85vw">
                <Flex gap={8} textAlign="left">
                    <Text textStyle="2xl" color="#6D7685" w="300px" fontWeight="bold" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{props.ticketNum + t("PiecePerVoiceGiftTicket")}</Text>
