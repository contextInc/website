    ...
    if (displayValue === 'small') {
        ...
        return (
            <Stack bg="#FFFFFF" color="white" px={4} py={10} align="center" >
                <Text textStyle="lg"  color="#6D7685"  whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("episode1Mobile")}</Text>
                <Text textStyle="lg" marginTop={4} color="#6D7685" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("episode2Mobile")}</Text>
                <Text textStyle="lg" marginTop={12} color="#6D7685" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("episode3Mobile")}</Text>
                <Text textStyle="lg"  color="#6D7685" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("episode4Mobile")}</Text>
                <Text textStyle="lg" marginTop={12} color="#6D7685" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("episode5Mobile")}</Text>
        ...
        return (
            <Stack bg="#FFFFFF" color="white" px={248} py={50} align="center" >
                <Text textStyle="2xl"  color="#6D7685"  whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("episode1")}</Text>
                ...
                <Text textStyle="2xl" marginTop={4}  color="#6D7685" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("episode7")}</Text>
            </Stack>
        );
    }
}