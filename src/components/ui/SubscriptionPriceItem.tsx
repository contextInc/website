        ...
        return (
            <Box h={100} w="85vw">
                <Flex gap={8} textAlign="left">
                    ...
                    <Text textStyle="lg" color="#6D7685" w="160px" fontWeight="bold" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{props.priceDetail}</Text>
                    <Text textStyle="lg" color="#6D7685" w="200px" fontWeight="bold" whiteSpace="pre-wrap" fontFamily='Open Sans, sans-serif'>{t("Per6Months")}</Text>
